...
public class KafkaConfig {
    ...
    @Value("${product-validation-success.spring.kafka.template.default-topic}")
    private String productValidationSucessTopic;

    @Value("${product-validation-fail.spring.kafka.template.default-topic}")
    ...
    public NewTopic productValidationSucessTopic(){
        return buildTopic(productValidationSucessTopic);
    }
